...
--==	then
--==		---print("i2c init failed: bad arguments")
--==		return false
--==	end
	sda = d
	scl = c
...
--==		---print("i2c device failed: i2c not set up")
--==		return false
--==	end

--==	if dev < 0 or dev > 0x0ff then
--==		---print("i2c device failed: bad arguments")
--==		return false
--==	end

	if not setupDevice(dev) then
		---print("i2c device failed: no device")
		return false
	end
...
--==		---print("i2c read failed: device not set up")
--==		return nil
--==	end
